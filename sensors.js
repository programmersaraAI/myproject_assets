const apiUrl = "https://demo.thingsboard.io:443/api/deviceProfile/names?activeOnly=true";
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $.each(response, function (index, asset) {
                var listItem = $('<div class="col-12 col-sm-6 col-lg-4 mb-4 mb-3"><div class="card" ><div class="card-body text-center"><i class="bx bx-md bx-bar-chart-alt-2 mb-3"></i>' + asset.name + '</div><a href="sensorsdetails.html?profileId=' + asset.id.id + '" type="button" id="showButton" class="btn btn-primary">عرض</a></div></div>');
...
$(document).ready(function () {
    ...
    //console.log(str);
//alert(str)
        const apiEndpoint = 'https://demo.thingsboard.io:443/api/deviceProfileInfo/' + str;
         const accessToken = "eyJhbGciOiJIUzUxMiJ9..t3_5gpG9ZtUeu-vm9MANCTmBxXFlPlxtaLA6JOz3NzikvxXvlVK8OXl-E3qlFaP4AIRMJ4SN4x0T-HlQNu4l5A";
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    var html ='<div class="card"><div class="card-body"><h2>sensors  Details</h2>';
